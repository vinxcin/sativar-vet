...
export default function Experiences() {
    ...
    return (
        ...
        >
            ...
            <p className="text-xl leading-relaxed text-gray-300 md:px-80 text-center mt-6 mb-20">
                ...
                {Cards.map((card, index) => (
                    ...
                    >
                        ...
                        <div className="relative bg-white/90 backdrop-blur-md rounded-2xl p-4 flex flex-col h-full z-10 shadow-md shadow-[#fd9a0c]/25">
                            ...
                            />
                            <h3
                                className="text-lg title md:text-xl text-[#050111] font-semibold mb-1 tracking-tight"
                            >
                                {card.title}
                            </h3>
